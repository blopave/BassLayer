export const STRINGS = {
  es: {
    ...
    "event.searchTickets": "Buscar entradas",
    "event.hoursShort": "hs",
    ...
    "feed.searchPlaceholder": "Buscar eventos, DJs, venues...",
    "feed.empty.search": "No encontramos nada para",
    "feed.empty.searchHint": "Probá con otro término.",
    "feed.empty.weekend": "Sin eventos este finde. Probá quitando el filtro.",
    "feed.empty.filter": "Sin eventos para este filtro. Probá con otro o volvé pronto.",
    "feed.empty.news": "Sin noticias para",
    "feed.empty.newsHint": "El mercado está tranquilo.",
  ...
  en: {
    ...
    "feed.searchPlaceholder": "Search events, DJs, venues...",
    "feed.empty.search": "Nothing found for",
    "feed.empty.searchHint": "Try a different term.",
    "feed.empty.weekend": "No events this weekend. Try removing the filter.",
    "feed.empty.filter": "No events for this filter. Try another or check back soon.",
    "feed.empty.news": "No news for",
    "feed.empty.newsHint": "The market is quiet.",
