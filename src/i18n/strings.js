export const STRINGS = {
  es: {
    ...
    "feed.empty.filter": "Esta noche no hay nada en este género. Probá otro estilo o volvé el viernes.",
    "feed.empty.news": "Mercado tranquilo en",
    "feed.empty.newsHint": "Sin movimiento por ahora.",
    "feed.empty.bassNews": "Sin notas nuevas. Los medios locales publican a su ritmo.",
